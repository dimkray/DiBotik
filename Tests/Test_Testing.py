...
with Profiler() as p:
    ...
    Test.Add(service + '.isWork', 'автопроверка', test, 0)

    test = Comp.isWork(1, None)
    Test.Add(service + '.isWork', 'автопроверка', test, 1)
    ...
    Test.Add(service + '.sWork', 'автопроверка', test, 1)

    test = Comp.sWork('#bug: Всё плохо :(')
    Test.Add(service + '.sWork', 'автопроверка', test, 0)
    ...
    Test.Add(service + '.isType', 'автопроверка', test, 1)

    test = Comp.isType(5.0, 5)
    Test.Add(service + '.isType', 'автопроверка', test, 0)
    ...
    Test.Add(service + '.Equal', 'автопроверка', test, 0)

    test = Comp.Equal(5.0, 5)
    Test.Add(service + '.Equal', 'автопроверка', test, 1)
    ...
    Test.Add(service + '.fEqual', 'автопроверка', test, 0)

    test = Comp.fEqual(1, 2)
    Test.Add(service + '.fEqual', 'автопроверка', test, 0)

    test = Comp.fEqual(1.000, 0.995)
    Test.Add(service + '.fEqual', 'автопроверка', test, 0.5, critery=0.49)

    test = Comp.fEqual(0.0001, 0)
    Test.Add(service + '.fEqual', 'автопроверка', test, 0)

    test = Comp.fEqual(0.998, 0.998)
    Test.Add(service + '.fEqual', 'автопроверка', test, 1)
    ...
    Test.Add(service + '.strEqual', 'автопроверка', test, 0.95)
    
    test = Comp.strEqual('Тест', 'тест')
    Test.Add(service + '.strEqual', 'автопроверка', test, 0.9)
    
    test = Comp.strEqual('тест', 'тест')
    Test.Add(service + '.strEqual', 'автопроверка', test, 1)

    test = Comp.strEqual(1, 'тест')
    Test.Add(service + '.strEqual', 'автопроверка', test, 0.0)
    ...
    Test.Add(service + '.strEqual', 'автопроверка', test, 0.45)

    # listEqual
    test = Comp.listEqual('тесты', 'тест')
    Test.Add(service + '.listEqual', 'автопроверка', test, 0.8)
    
    test = Comp.listEqual([1, 2, 3, 4, 5], [1, 2, 3, 5, 4])
    Test.Add(service + '.listEqual', 'автопроверка', test, 0.6, critery=0.9)
    
    test = Comp.listEqual(['1', '2', '6'], ['1', '2', '3'])
    Test.Add(service + '.listEqual', 'автопроверка', test, 0.666, critery=0.8)
